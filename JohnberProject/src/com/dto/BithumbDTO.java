...
public class BithumbDTO {
	...
	public BithumbDTO(String bithumb_pk, String bithumb_date, String currency, double opening_price,
			...
			double fluctate_rate_24H, double join_date) {
		super();
	...
	public double getJoin_date() {
		return join_date;
	}

	public void setJoin_date(double join_date) {
		this.join_date = join_date;
	}
	...
	public String toString() {
		return "BithumbDTO [bithumb_pk=" + bithumb_pk + ", bithumb_date=" + bithumb_date + ", currency=" + currency
				...
				+ fluctate_rate_24H + ", join_date=" + join_date + "]";
	}
}
